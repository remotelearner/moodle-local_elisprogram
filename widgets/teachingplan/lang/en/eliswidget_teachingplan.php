...
$string['class_table_class_cell'] = '<a href=\'{$a->wwwroot}/local/elisprogram/index.php?s=cls&action=view&id={$a->element_id}\'>{$a->idnumber}</a><br/>Moodle Course: <a href=\'{$a->wwwroot}/course/view.php?id={$a->moodlecourseid}\'>{$a->moodlecoursefullname}</a>';
...
$string['enrolled'] = 'Enrolled (waiting)';
