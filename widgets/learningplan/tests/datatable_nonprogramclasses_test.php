...
/**
 * Test \eliswidget_learningplan\datatable\nonprogramclasses.
 * @group eliswidget_learningplan
 */
class datatable_nonprogramclasses_testcase extends \elis_database_test {
    /**
    ...
    public function test_get_search_results() {
        ...
        // Validate.
        $this->assertTrue((isset($classar[$test1['course']->id])));
        $this->assertTrue((isset($classar[$test2['course']->id])));
        $this->assertFalse((isset($classar[$test3['course']->id])));
        $this->assertFalse((isset($classar[$test4['course']->id])));
        $this->assertFalse((isset($classar[$test5['course']->id])));
        $this->assertTrue((isset($classar[$test6['course']->id])));
        $this->assertFalse((isset($classar[$test7['course']->id])));
        $this->assertEquals(3, count($classar));
    }
}
