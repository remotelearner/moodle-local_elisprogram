...
/**
 * Event for when a program recurs.
 */
class curriculum_recurrence extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('curriculum_recurrence', 'local_elisprogram');
    }
