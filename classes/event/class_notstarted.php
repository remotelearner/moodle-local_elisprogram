...
/**
 * Event for when a class is not started.
 */
class class_notstarted extends \core\event\base {
    ...
    public function get_description() {
        return 'A class was not started';
    }
    ...
    public static function get_name() {
        return get_string('class_notstarted', 'local_elisprogram');
    }
