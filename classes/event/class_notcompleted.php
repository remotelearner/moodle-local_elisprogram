...
/**
 * Event for when a class is not completed.
 */
class class_notcompleted extends \core\event\base {
    ...
    public function get_description() {
        return 'A class was not completed';
    }
    ...
    public static function get_name() {
        return get_string('class_notcompleted', 'local_elisprogram');
    }
