...
/**
 * Event for when a userset is created.
 */
class pm_userset_created extends \core\event\base {
    ...
    public function get_description() {
        return 'A userset has been created';
    }
    ...
    public static function get_name() {
        return get_string('pm_userset_created', 'local_elisprogram');
    }
