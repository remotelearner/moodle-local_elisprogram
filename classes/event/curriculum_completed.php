...
/**
 * Event for when a program is completed.
 */
class curriculum_completed extends \core\event\base {
    ...
    public function get_description() {
        return 'A program was completed';
    }
    ...
    public static function get_name() {
        return get_string('curriculum_completed', 'local_elisprogram');
    }
