 ...
 */
class crlm_class_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('class_completed', 'local_elisprogram');
    }
