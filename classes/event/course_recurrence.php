...
/**
 * Event for when a course recurs.
 */
class course_recurrence extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('course_recurrence', 'local_elisprogram');
    }
