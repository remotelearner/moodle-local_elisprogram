 ...
 *     boolean orderfilters      Set to true to order filters by name and false by order they are added.
 *
...
$.fn.deepsight_filter_generator = function(options) {
    ...
    this.add_filter = function(label, type, opts) {
        var filter = $('<span></span>').prop('id', 'filter_'+opts.name);
        main.before(filter);
     ...
     */
    this.render_available_filters = function(cleardropdowns) {
    ...
    this.initialize = function() {
        ...
        main.render_available_filters(false);
    }
