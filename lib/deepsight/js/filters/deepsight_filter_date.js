...
$.fn.deepsight_filter_date = function(options) {
    ...
    this.initialize = function() {
        ...
        // Check if initialvalue is set and is valid.
        if (typeof opts.initialvalue !== "undefined" && typeof opts.initialvalue[0] !== "undefined") {
            if (typeof opts.initialvalue[0].year !== "undefined") {
                initialval = opts.initialvalue[0];
            }
        }

        // If there is a initial value than update label title.
        if (initialval != '') {
        ...
        // Set filter to date in initial value.
        if (initialval != '') {
