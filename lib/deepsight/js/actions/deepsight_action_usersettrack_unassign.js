...
/**
 * DeepSight Userset-Track Unassignment
 * An action used in userset-track and track-userset unassignments with a checkbox for the "recursive" flag.
 *
 * Usage:
 *     $('[button selector]').each(function() { $(this).deepsight_action_usersettrack_unassign(); });
 *
 * Required Options:
...
$.fn.deepsight_action_usersettrack_unassign = function(options) {
    this.default_opts = {
        rowdata: {},
        parent: null,
        sesskey: null,
    ...
    this.render_action = function() {
        ...
        // Assemble form.
        var recursiveid = 'deepsight_action_usertrack_unassign_recursive'; // TBD: bulk?
