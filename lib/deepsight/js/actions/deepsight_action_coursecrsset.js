...
/** @var array lepcrssetactivelist is an array of table ids for active coursesets */
var lepcrssetactivelist = [];

(function($) {

/**
 * DeepSight CourseSet-Course Action Panel
 * Adds a confirmation action panel that can be used to ensure the user actually wants to perform the action.
 *
 * Usage:
 *     $('[button selector]').each(function() { $(this).deepsight_action_coursecrsset(); });
 *
 * Required Options:
 ...
 */
$.fn.deepsight_action_coursecrsset = function(options) {
    this.default_opts = {
        rowdata: null,
        parent: null,
        sesskey: null,
        ...
        langconfirmactive: 'This course has active enrolments - are you sure?',
