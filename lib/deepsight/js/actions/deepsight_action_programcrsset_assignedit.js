...
$.fn.deepsight_action_programcrsset_assignedit = function(options) {
    ...
    this.render_action = function(data) {
        ...
        var reqcredits = (bulkeditui == true)
                ? '<input type="checkbox" name="reqcredits_enabled" class="reqcredits_enabled" '+reqcreditsenabledchecked+'/>' : '';
        reqcredits += '<input type="text" class="field-reqcredits" name="reqcredits" value="'+reqcreditsval+'" />';
        ...
        var reqcourses = (bulkeditui == true)
                ? '<input type="checkbox" name="reqcourses_enabled" class="reqcourses_enabled" '+reqcoursesenabledchecked+'/>' : '';
        reqcourses += '<input type="text" class="field-reqcourses" name="reqcourses" value="'+reqcoursesval+'" />';
        ...
        // Headers
        form += '<div>';
        form += '<span>'+opts.langreqcredits+'</span>';
        form += '<span>'+opts.langandor+'</span>';
        form += '<span>'+opts.langreqcourses+'</span>';
        form += '</div>';
        // Inputs
        form += '<div>';
