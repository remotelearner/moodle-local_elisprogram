...
$.fn.deepsight_action_usersettrack_assignedit = function(options) {
    ...
    this.render_action = function() {
        ...
        // Assemble form.
        var recursiveid = 'deepsight_action_usertrack_assigned_recursive'; // TBD: bulk?
    ...
    this.precomplete_action = function(e) {
        ...
        if (opts.parentid == 'bulklist' && typeof(bulkconfirmed) == 'undefined') {
            ...
            main.actiontr.find('i.elisicon-confirm')
                ...
                .bind('click', function(e) { main.complete_action(e, autoenrol, recursive); });
        } else {
            main.complete_action(e, autoenrol, recursive);
        }
    }
     ...
     */
    this.complete_action = function(e, autoenrol, recursive) {
