...
$.fn.deepsight_action_usersetprogram_assignedit = function(options) {
    ...
    this.render_action = function() {
        ...
        // Determine state of auto-enrol checkbox.
        ...
        // Assemble form.
        var recursiveid = 'deepsight_action_usersetprogram_assigned_recursive'; // TBD: bulk?
        if (opts.parentid != 'bulklist') {
            recursiveid += '_'+opts.rowdata.element_id;
        }
        var autoassocid = 'deepsight_action_usersetrpgoram_assigned_autoassoc'; // TBD: bulk?
        if (opts.parentid != 'bulklist') {
