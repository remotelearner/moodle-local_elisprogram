...
function xmldb_local_elisprogram_upgrade($oldversion=0) {
    ...
    if ($result && $oldversion < 2014082509) {
        $file = $CFG->dirroot.'/local/elisprogram/db/install.xml';
        ...
        upgrade_plugin_savepoint($result, '2014082509', 'local', 'elisprogram');
    }

    if ($result && $oldversion < 2014082511) {
        ...
        upgrade_plugin_savepoint($result, '2014082511', 'local', 'elisprogram');
    }
