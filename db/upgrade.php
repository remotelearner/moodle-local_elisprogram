...
function xmldb_local_elisprogram_upgrade($oldversion=0) {
    ...
    if ($result && $oldversion < 2015051105) {
        $file = $CFG->dirroot.'/local/elisprogram/db/install.xml';
        ...
        upgrade_plugin_savepoint($result, '2015051105', 'local', 'elisprogram');
    }

    if ($result && $oldversion < 2015051107) {
        ...
        upgrade_plugin_savepoint($result, '2015051107', 'local', 'elisprogram');
    }
